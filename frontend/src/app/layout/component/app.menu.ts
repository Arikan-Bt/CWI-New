          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                routerLink: ['/pages/settings/product-visuals'],
                permission: 'Permissions.Menus.Settings.BrandManagement',
              },
              {
                label: 'Purchase Price List',
                icon: 'pi pi-fw pi-dollar',
                routerLink: ['/pages/settings/purchase-price-list'],
                permission: 'Permissions.Menus.Settings.PurchasePriceManagement',
              },
              {
                label: 'Sales Price List',
                icon: 'pi pi-fw pi-dollar',
                routerLink: ['/pages/settings/sales-price-list'],
                permission: 'Permissions.Menus.Settings.SalesPriceManagement',
              },
            ],
          },
        ],
